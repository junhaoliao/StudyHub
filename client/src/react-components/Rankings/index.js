...
export class Rankings extends React.Component {
    ...
    plotLikesRankings(rankings) {
        ...
        return (
            < Table.Body >
            {
                rankings.map((course) => (
                    < Table.Row >
                    < Table.Cell > < a href = {`/courses/${course.name}`
            }
    ...
    render() {
        ...
        return (
            ...
            < NavBar / >
            < div
        className = {"rankings_container"} >
            < Menu
        secondary >
        < Menu.Item
        name = "Rankings"
        className = {"rankings_header"}
        />
        < Menu.Item
        position = {"right"} >
            < Button
