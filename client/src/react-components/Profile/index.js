...
export class Profile extends React.Component {
    ...
    profilePage() {
        ...
        className = "ui attached message" >
            < h2
        className = "ui blue inverted center aligned icon header" >
            < i
        ...
        columns = {1} >
            < Grid.Column >
            < div
        className = "ui huge black horizontal label" > Username < /div>
            < div
        className = "ui huge blue horizontal label" > {username} < /div>
            < /Grid.Column>
            < /Grid.Row>
        ...
        columns = {2} >
            < Grid.Column >
            < div
        className = "ui huge black horizontal label" > Gender < /div>
            < div
        className = "ui huge blue horizontal label" > {gender} < /div>
            < /Grid.Column>
            < Grid.Column >
            < div
        className = "ui huge black horizontal label" > GPA < /div>
            < div
        className = "ui huge blue horizontal label" > {GPA} < /div>
            < /Grid.Column>
            < /Grid.Row>
        ...
        columns = {2} >
            < Grid.Column >
            < div
        className = "ui  huge black horizontal label" >
            Level
        of
        Education
        < /div>
    ...
    ProfilePageEdit() {
        ...
        className = "ui huge black horizontal label" > Username < /div>
            < div
        className = "ui medium blue input focus" >
            < input
        ...
        onChange = {(e)
    =>
        this.handleProfileFormChange(e.target)
    }
        />
        < /div>
        < /Grid.Column>
    ...
    <
...

        {
            ...
            onClick = {()
        =>
            remove_coursesTeaching(this, course)
        }
        >
            {
                course.name
    ...
    <
...

        {
            ...
            onClick = {()
        =>
            remove_coursesTaking(this, course)
        }
        >
            {
                course.name
