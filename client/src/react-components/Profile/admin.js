...
export class ProfileAdmin extends React.Component {
    ...
    profilePage() {
        ...
        className = "ui attached message" >
            < h2
        className = "ui yellow inverted center aligned icon header" >
            < i
        ...
        className = "ui huge black horizontal label" > Gender < /div>
            < div
        className = "ui huge yellow horizontal label" > {gender} < /div>
            < /Grid.Column>
            < Grid.Column >
            < div
        className = "ui huge black horizontal label" > GPA < /div>
            < div
        className = "ui huge yellow horizontal label" > {GPA} < /div>
            < /Grid.Column>
            < /Grid.Row>
    ...
    ProfilePageEdit() {
        ...
        className = "ui huge black horizontal label" > Username < /div>
            < div
        className = "ui medium yellow input focus" >
            < input
