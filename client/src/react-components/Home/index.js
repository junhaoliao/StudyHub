...
class Home extends React.Component {
    ...
    render() {
        ...
        className = "ui attached message" >
            < h2
        className = "ui blue center aligned icon header" >
            < i
        ...
        < /div>
        < div
        className = "sign_up_box_container" >
            {this.state.sign_up ? < SignupBox / >
    : <
        LoginBox / >
    }
    <
        ...
        >
            ...
            (
            < div
            className = "ui signup_prompt  warning " >
                < i
            className = "icon help" > < /i>
            Don
            't have an account?{" "}
    ...
    <
        ...
        columns = {2} >
            ...
            < Segment >
            < div
        className = {"user_type_icon_container"} > < Icon
        name = 'user'
        size = 'huge' / > < /div>
            < div
        className = {"user_description_container"} >
            < Item.Group >
            < Item >
            < Item.Content >
            < Item.Header > Become
        ...
        < List.Item >
        It
        's not that hard to become a teacher!
        < /List.Item>
        < /List>
        < /Item.Meta>
        < /Item.Content>
